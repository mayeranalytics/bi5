...
#[command(about = "Dump a bi5 file to stdout.")]
...
fn main() -> Result<(), Error> 
{
    ...
    let sep = &args.sep;
    println!("t{}bid{}ask{}bidvol{}askvol",sep,sep,sep,sep);
    if let Some(date_time) = args.date_time {
        for tick in ticks.iter() {
            let t: NaiveDateTime = date_time + Duration::milliseconds(tick.millisecs as i64);
            println!("{}{}{}{}{}{}{}{}{}", t, sep, tick.bid, sep, tick.ask, sep, tick.bidvol, sep, tick.askvol);
        }
    } else {
        for tick in ticks.iter() {
            println!("{}{}{}{}{}{}{}{}{}", tick.millisecs, sep, tick.bid, sep, tick.ask, sep, tick.bidvol, sep, tick.askvol);
        }
    }
    Ok(())
}
